            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Dropdown - Alerts Bildirim Paneli başlangıcı -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- Bildirim paneli bitiş -->
                        </li>

                        <!-- Nav Item - Messages  paneli başlangıç-->
                        <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <!--  Mesajlar  paneli bitiş-->

                        <div class="topbar-divider d-none d-sm-block"></div>

                        <!--  Sağ üstteki kullanıcı info başlangıcı -->
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Douglas McGee</span>
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url(); ?>/static/img/undraw_profile.svg">
                            </a>
                        ...
                        <!-- Sağ üstteki kullanıcı info bitişi -->
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Daisy 2024</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
