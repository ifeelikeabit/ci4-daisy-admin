...
<body>
    <div class="container mt-5">
        ...
        <form action="<?= base_url() ?>page/save/<?= $page['id'] ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" i name="slug" value="<?= $page['slug'] ?>" required placeholder="Enter slug">
                </div>
            </div>


            <!-- Content --> <textarea id="content" name="content" > <?= $page['content'] ?></textarea>

            <!-- Role Selection -->
            <div class="mb-3">
                <label for="status" class="form-label">status</label>
                <select class="form-select" name="status" required>
                    <option hidden selected><?= $page['status'] ?></option>
